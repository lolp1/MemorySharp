...
namespace Binarysharp.MSharp.Helpers
{
    ...
    public static class SerializationHelper
    {
        ...
        /// <summary>
        /// Serializes the specified object and writes the Json document to the specified path using <see cref="Encoding.UTF8"/> encoding.
        /// </summary>
        /// <typeparam name="T">The type of the object to serialize.</typeparam>
        /// <param name="obj">The object to serialize.</param>
        /// <param name="path">The path where the file is saved.</param>
        public static void ExportToJsonFile<T>(T obj, string path)
        {
            ExportToJsonFile(obj, path, Encoding.UTF8);
        }
        #endregion
        ...
        public static string ExportToJsonString<T>(T obj)
        {
        ...
        /// <param name="path">The path where the object is read.</param>
        /// <returns>The deserialized object.</returns>
        public static T ImportFromJsonFile<T>(string path)
        {
            return ImportFromJsonFile<T>(path, Encoding.UTF8);
        }
        #endregion
        ...
        /// <param name="serializedObj">The string representing the serialized object.</param>
        /// <returns>The deserialized object.</returns>
        public static T ImportFromJsonString<T>(string serializedObj)
        {
